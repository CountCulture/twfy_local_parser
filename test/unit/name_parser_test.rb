...
class NameParserTest < Test::Unit::TestCase
  OriginalNameAndParsedName = {
    ...
    "Mr Fred Flintstone" => {:title => "Mr", :first_name => "Fred", :last_name => "Flintstone"},
    "Prof Dr Fred Flintstone" => {:title => "Prof Dr", :first_name => "Fred", :last_name => "Flintstone"},
    "Dr Fred Flintstone" => {:title => "Dr", :first_name => "Fred", :last_name => "Flintstone"},
    "Dr. Fred Flintstone" => {:title => "Dr", :first_name => "Fred", :last_name => "Flintstone"},
    "Councillor Mrs Wilma Flintstone" => {:title => "Mrs", :first_name => "Wilma", :last_name => "Flintstone"},
    "Councillor Mrs. Wilma Flintstone" => {:title => "Mrs", :first_name => "Wilma", :last_name => "Flintstone"},
    "Professor Fred H. Flintstone" => {:title => "Professor", :first_name => "Fred H", :last_name => "Flintstone"},
